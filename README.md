...
🌏 Aspiring AI, Robotics & Embedded Systems Engineer (Open to International Internships)
...
Voice-controlled intelligent assistant integrating AI with embedded systems.  
**Technologies:** Python, ESP32, IoT, Speech Recognition, Servo Control  
**Features:**  
...
**Programming & Development:** Python, C, C++, HTML, CSS, JavaScript, ReactJS, NodeJS, MongoDB, MySQL, MATLAB, Machine Learning  
**Embedded & IoT:** Arduino, ESP32, Raspberry Pi, IoT Integration, Hardware-Software Integration  
**Tools & Platforms:** GitHub, Overleaf, Microsoft Office  
